      ...
      <div className="relative flex min-h-svh w-full bg-background-v2 font-onest text-foreground-v2">
        <main className="relative flex w-full flex-1 flex-col">
          ...
          <div className="mx-auto w-full max-w-6xl px-4 pb-24 md:px-8 lg:px-12">
            {/* Header */}
            <header className="mt-4 flex flex-col gap-4 md:-mt-16">
              ...
              <h1 className="py-0.5 text-xl font-bold leading-[1.25] text-foreground-v2 sm:text-2xl md:text-4xl break-words">
                {event.title}
              </h1>
