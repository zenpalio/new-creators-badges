...
const dudes = [
  { src: guy1.url, portrait: portrait1.url, name: "MARCO", color: "#1d3a8a" },
  { src: guy2.url, portrait: portrait2.url, name: "JAKE", color: "#b026ff" },
  { src: guy3.url, portrait: portrait3.url, name: "DIEGO", color: "#1d3a8a" },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <g stroke="rgba(15,18,40,0.85)" strokeWidth="1.2" fill="none" strokeLinecap="round" filter="url(#rough)">
      ...
      {[
        ...
        { text: "MAN HOLE", top: "14%", left: "66%", rotate: 6, size: "clamp(1.1rem, 3vw, 2.8rem)", color: "#39ff14" },
        { text: "DON'T TELL DAD", top: "70%", left: "8%", rotate: -10, size: "clamp(0.9rem, 2.2vw, 2rem)", color: "#ffdd00" },
