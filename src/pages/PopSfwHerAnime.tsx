...
import bg from "@/assets/popunder-sfw-her-anime/bg.jpg.asset.json";
import bgSister from "@/assets/popunder-sfw-her-anime/bg_sister.jpg.asset.json";
import bgGoth from "@/assets/popunder-sfw-her-anime/bg_goth.jpg.asset.json";
import bgMilf from "@/assets/popunder-sfw-her-anime/bg_milf.jpg.asset.json";
import sisterA from "@/assets/popunder-sfw-her-anime/sister_a.jpg.asset.json";
import sisterB from "@/assets/popunder-sfw-her-anime/sister_b.jpg.asset.json";
import gothA from "@/assets/popunder-sfw-her-anime/goth_a.jpg.asset.json";
import gothB from "@/assets/popunder-sfw-her-anime/goth_b.jpg.asset.json";
import milfA from "@/assets/popunder-sfw-her-anime/milf_a.jpg.asset.json";
import milfB from "@/assets/popunder-sfw-her-anime/milf_b.jpg.asset.json";
...
const babes = [
  {
    name: "MIA",
    role: "STEP-SISTER",
    tag: "Brat · Forbidden Tease",
    desc: "Your step-sister is a total brat who loves to tease you. Tonight she's pushed too far — time to teach her a lesson.",
    tooltip: "make me behave 😝",
    default: sisterA.url,
    spicy: sisterB.url,
    sceneBg: bgSister.url,
    accent: "#ff5fa2",
  },
  {
    name: "KAYA",
    role: "GOTH TRANSFER",
    tag: "Dangerous · Detention",
    desc: "New goth transfer with a dangerous reputation. The teacher left you alone with her in detention. Good luck.",
    tooltip: "stay after class 🖤",
    default: gothA.url,
    spicy: gothB.url,
    sceneBg: bgGoth.url,
    accent: "#a855f7",
  },
  {
    name: "MS. VOSS",
    role: "MILF TEACHER",
    tag: "Strict · After-Class",
    desc: "Your angry teacher kept you after class for being late. Now she's about to punish you in ways you never expected.",
    tooltip: "detention, naughty boy 💋",
    default: milfA.url,
    spicy: milfB.url,
    sceneBg: bgMilf.url,
    accent: "#ff7a3d",
    ...
    >
      <style>{`
        ...
        @media (max-width: 1023px) {
          .sfw-root { min-height: auto !important; height: auto !important; padding-bottom: 3rem; }
          .headline-wrap { position: relative !important; top: auto !important; left: auto !important; transform: none !important; margin: 0 auto; padding-top: 4.5rem; }
          .babe-card { position: relative !important; left: auto !important; bottom: auto !important; top: auto !important; transform: none !important; width: 86% !important; max-width: 360px !important; margin: 0 auto; }
          .babe-card .babe-inner { transform: none !important; }
          .babes-stack { display: flex !important; flex-direction: column; align-items: center; gap: 2rem; padding: 1.5rem 0 2rem; }
        }
        @media (max-width: 480px) {
          .babe-card { width: 90% !important; max-width: 300px !important; }
          .headline-wrap { padding-top: 4rem; }
          .babes-stack { gap: 1.5rem; padding: 1rem 0 1.5rem; }
        }
        @media (min-width: 768px) and (max-width: 1023px) {
          .babes-stack { gap: 2.5rem; padding: 2rem 0 3rem; }
        }
        @keyframes floatY {
          0%, 100% { transform: scale(1.06) translateY(0); }
          50% { transform: scale(1.06) translateY(-6px); }
        }
        .babe-card:hover .babe-inner, .babe-card:active .babe-inner, .babe-card:focus-within .babe-inner {
          animation: floatY 2.6s ease-in-out infinite;
        }
        .img-default { opacity: 1; transition: opacity 500ms ease; }
        .img-spicy { opacity: 0; transition: opacity 500ms ease; }
        .babe-card:hover .img-default, .babe-card:active .img-default, .babe-card:focus-within .img-default { opacity: 0; }
        .babe-card:hover .img-spicy, .babe-card:active .img-spicy, .babe-card:focus-within .img-spicy { opacity: 1; }
        @keyframes petalFall {
        ...
        .petal {
          position: absolute; top: -5vh; width: 14px; height: 14px;
          background: radial-gradient(circle at 30% 30%, #ffd6e8, #ff80aa);
          border-radius: 80% 0 80% 0; opacity: 0.85; pointer-events: none;
      ...
      <div className="sfw-root relative w-full h-screen">
        ...
        >
          ...
          >
            Who's going to drive you wild tonight?
          </h1>
          <div
          ...
          >
            Pick a roleplay. Hover to see what she's hiding.
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: `0 0 24px ${b.accent}cc, 0 10px 30px rgba(0,0,0,0.5)`,
                ...
                <div
                  ...
                  style={{ ['--accent' as never]: b.accent }}
                >
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: "14px",
                      overflow: "hidden",
                      boxShadow: `0 0 0 3px rgba(255,255,255,0.92), 0 0 0 5px ${b.accent}, 0 18px 40px rgba(0,0,0,0.7), 0 0 0px ${b.accent}00`,
                      background: "#0a0414",
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        background: `radial-gradient(ellipse at center, transparent 40%, ${b.accent}33 100%)`,
                        mixBlendMode: "screen",
                      }}
                    />
                    ...
                    >
                      <div
                        ...
                        style={{
                          ...
                          color: "#ffffff",
                          fontFamily: "'Onest', sans-serif",
                          textShadow: `0 2px 8px rgba(0,0,0,0.95), 0 0 16px ${b.accent}aa`,
                          lineHeight: 1.05,
                        }}
                      >
                        {b.name}
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        color: b.accent,
                        textShadow: `0 0 10px ${b.accent}88, 0 2px 4px rgba(0,0,0,0.8)`,
                      }}
                    >
                      {b.tag}
                    </div>
