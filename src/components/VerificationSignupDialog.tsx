      ...
      <div className="relative w-full max-w-md rounded-2xl border border-white/10 bg-neutral-800/95 shadow-2xl">
        <div className="p-6 sm:p-7">
          ...
          <p className="mt-4 text-sm italic text-muted-foreground">
            To comply with age-related regulations in your region, we verify
            that users meet the minimum age to access our service. This protects
            both you and our platform, ensuring that everyone uses our service
            responsibly.
          </p>
