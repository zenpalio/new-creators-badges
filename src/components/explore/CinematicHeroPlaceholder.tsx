 ...
 */
const CinematicHeroPlaceholder = ({ className, ...props }: CinematicHeroPlaceholderProps) => {
  return (
    <section
      className={cn("relative w-full shrink-0 overflow-hidden select-none", className)}
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(180deg, transparent 0%, hsl(var(--background-v2)) 100%)",
        }}
      />
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-[1600px] items-end px-6 pb-20 md:items-center md:pb-0">
        <div className="max-w-xl space-y-4">
          ...
          <div className="space-y-3">
            <Skeleton className="h-10 w-[92%] rounded-lg bg-white/10 md:h-14" />
            <Skeleton className="h-10 w-[72%] rounded-lg bg-white/10 md:h-14" />
          </div>
          <div className="space-y-2">
            <Skeleton className="h-4 w-full max-w-lg rounded-md bg-white/10" />
            <Skeleton className="h-4 w-full max-w-lg rounded-md bg-white/10" />
            <Skeleton className="h-4 w-[88%] max-w-lg rounded-md bg-white/10" />
          </div>
          <div className="hidden flex-wrap gap-2 pt-1 md:flex">
            <Skeleton className="h-7 w-20 rounded-[5px] bg-white/10" />
            <Skeleton className="h-7 w-24 rounded-[5px] bg-white/10" />
            <Skeleton className="h-7 w-16 rounded-[5px] bg-white/10" />
          </div>
