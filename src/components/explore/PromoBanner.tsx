...
> = {
  premium: {
    ...
    glow: "bg-[radial-gradient(circle_at_70%_50%,hsl(213_100%_50%/0.10),transparent_60%)]",
    monogram: "P",
  ...
  tokens: {
    ...
    glow: "bg-[radial-gradient(circle_at_75%_50%,hsl(45_90%_45%/0.10),transparent_60%)]",
    monogram: "20",
    monoColor: "text-black/60",
  },
  gift: {
    ...
    glow: "bg-[radial-gradient(circle_at_75%_50%,hsl(340_90%_45%/0.12),transparent_60%)]",
    monogram: "★",
    monoColor: "text-black/60",
  },
  feature: {
    ...
    glow: "bg-[radial-gradient(circle_at_75%_50%,hsl(265_90%_50%/0.12),transparent_60%)]",
    monogram: "✦",
    monoColor: "text-black/60",
  },
};
